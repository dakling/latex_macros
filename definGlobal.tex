...
\NewDocumentCommand {\atpos} { m m } { \bigg|_{{#1} = {#2}} } % use evalfun instead!
\NewDocumentCommand {\evalfunI} {m m m} {\left.\kern-\nulldelimiterspace {#1} \right|_{{#2} = {#3}}}
\NewDocumentCommand {\evalfun} {m m m} {\left. #1 \right|_{{#2} = {#3}}}
% transformed (symmetries)
\NewDocumentCommand {\tra} {m} {\traAltEq{#1}}
\NewDocumentCommand {\traAnco} {m} {#1 \rightarrow}
\NewDocumentCommand {\traAlt} {m} {#1^* }
\NewDocumentCommand {\traAltEq} {m} {{#1}^* = }

\NewDocumentCommand {\einsteinSum} {m g} {
...
\NewDocumentCommand {\diffGeneric} { m m m g } {
    \IfNoValueTF {#4}
        ...
        {\int_compare:nTF{ #4=2 } % second derivatives in Einstein notation
            ...
            {{\cfrac{#3^{#4} #1}{#3 #2 ^{#4}}}} % higher derivatives, Einstein notation won't make sense in general
        }
}
\ExplSyntaxOff
% total derivative
...
\NewDocumentCommand {\ddl} {m m g} { \diffLongGeneric{#1}{#2}{d}{#3} }
...
% velocity moments
\NewDocumentCommand {\umv} {} {
\bar{\vv{U}}
}
\NewDocumentCommand {\uav} {} {
\hat{\vv{U}}
}
\NewDocumentCommand {\ufv} {} {
...
\NewDocumentCommand {\umLongNoExp} {g g g g} {
    \IfNoValueTF{#1}
        {{ \mean{U} }}
        {\IfNoValueTF{#2}
            {{\mean{U}_{#1}}}
...
\NewDocumentCommand {\ufLongNoExp} {g g g g} {
    \IfNoValueTF{#1}
        {{ u }}
        {\IfNoValueTF{#2}
            {{u_{#1}}}
...
\NewDocumentCommand {\pa} { g } { \hat{P} }
\NewDocumentCommand {\ka} { g } { \hat{k} }
...
\NewDocumentCommand {\infGenGalDiff} { g } {
    \IfNoValueTF{#1} 
    {\tilde{\infGen}_{\text{Gal}}}
    {\tilde{\infGen}_{{\text{Gal}_{{#1}}}}}
}
\NewDocumentCommand {\infGenRot} { g }
{\IfNoValueTF{#1}
    {\infGen{{\text{rot}_{\alpha}}}}
    {\infGen{{\text{rot}_{#1}}}}}

\NewDocumentCommand {\infGenP} {} {\infGen{P}}
\NewDocumentCommand {\infGenPDiff} {} {\tilde{\infGen}_{P}}
\NewDocumentCommand {\infGenScI} {} {\infGen{\text{Sc},I}}
\NewDocumentCommand {\infGenScII} {} {\infGen{\text{Sc},II}}
...
\NewDocumentCommand {\infGenTransStatI} { g } {%
    \IfNoValueTF{#1}
        {X_{\text{Tr,stat},I}}
        {X_{\text{Tr,stat},I, {#1} }}}
\NewDocumentCommand {\infGenTransStatII} { g } {%
    \IfNoValueTF{#1}
        {X_{\text{Tr,stat},II}}
        {X_{\text{Tr,stat},II, {#1} }}}
%Global form
...
\NewDocumentCommand {\gloSymmScI} {} {\gloSymm{\text{Sc},I}}
\NewDocumentCommand {\gloSymmScII} {} {\gloSymm{\text{Sc},II}}
...
\NewDocumentCommand {\gloSymmTransStatI} { g } {%
    \IfNoValueTF{#1}
        {T_{\text{Tr,stat},I}}
        {T_{\text{Tr,stat},I, {#1} }}}
\NewDocumentCommand {\gloSymmTransStatII} { g } {%
    \IfNoValueTF{#1}
        {T_{\text{Tr,stat},II}}
        {T_{\text{Tr,stat},II, {#1} }}}
...
\NewDocumentCommand {\grpT} {} {\grp{T}}
\NewDocumentCommand {\grpX} { g } {
    \IfNoValueTF{#1}
        {\grp{x_i}}
        {\grp{x_{#1}}}
}
\NewDocumentCommand {\grpGal} { g } {
    \IfNoValueTF{#1}
        {\grp{\text{Gal}_{i}}}
        {\grp{\text{Gal}_{#1}}}
}
\NewDocumentCommand {\grpRot} { g } {
    \IfNoValueTF{#1}
        {\grp{\text{rot}_{\alpha}}}
        {\grp{\text{rot}_{#1}}}
}
\NewDocumentCommand {\grpP} {} {\grp{P}}
\NewDocumentCommand {\grpScI} {} {\grp{\text{Sc},I}}
\NewDocumentCommand {\grpScII} {} {\grp{\text{Sc},II}}
\NewDocumentCommand {\grpScNs} {} {\grp{\text{Sc,ns}}}
\NewDocumentCommand {\grpScStat} {} {\grp{\text{Sc,stat}}}
\NewDocumentCommand {\grpTransStat} { m } {\grp{\text{Tr,stat,{#1}}}}
\NewDocumentCommand {\grpTransStatI} { g } {%
    \IfNoValueTF{#1}
        {\grp{\text{Tr,stat},I}}
        {\grp{\text{Tr,stat},I, {#1} }}}
\NewDocumentCommand {\grpTransStatII} { g } {%
    \IfNoValueTF{#1}
        {\grp{\text{Tr,stat},II}}
        {\grp{\text{Tr,stat},II, {#1} }}}
\NewDocumentCommand {\grpTransStatIII} { g } {%
    \IfNoValueTF{#1}
        {\grp{\text{Tr,stat},III}}
...
%for galileian group
\NewDocumentCommand{\ftGal} {m} {f_{\text{Gal}_{#1}} (t)}
\NewDocumentCommand{\ftpGal} {m} {f_{\text{Gal}_{#1}}^{\prime} (t)}
\NewDocumentCommand{\ftppGal} {m} {f_{\text{Gal}_{#1}}^{\prime\prime} (t)}
\NewDocumentCommand{\ftpppGal} {m} {f_{\text{Gal}_{#1}}^{\prime\prime\prime} (t)}
%for pressure translation
\NewDocumentCommand{\ftP} { } {f_{P} (t)}
\NewDocumentCommand{\ftpP} { } {f_{P}^{\prime} (t)}
\NewDocumentCommand{\ftppP} { } {f_{P}^{\prime\prime} (t)}
% model for a term
\NewDocumentCommand { \model } { m } {\mathcal{M}_{#1}}

% integration constant
\NewDocumentCommand { \intconst } { m g } {
\IfNoValueTF{#2}
  {c_{#1}}
  {c_{{#1}\_{#2}}}
}
...
% jet stuff
\NewDocumentCommand { \ucenterline } { } {U_{s}}
