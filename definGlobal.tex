...
\NewDocumentCommand {\diffJet} { m m  } { \underset{#2}{#1} }
% for a long first arg it is nicer to write d/dx(z+longArg)
\NewDocumentCommand {\diffLongGeneric} {m m m g} { \diffGeneric{ }{#2}{#3}{#4} \left( #1 \right) }
\NewDocumentCommand {\diffLongNormal} {m m m g} { \diffLongGeneric{#1}{#2}{d}{#3} }
\NewDocumentCommand {\diffLongPartial} {m m m g} { \diffLongGeneric{#1}{#2}{\partial}{#3} }
\NewDocumentCommand {\diffLongTotal} {m m m g} { \diffLongGeneric{#1}{#2}{D}{#3} }
...
% k- eps - model
\NewDocumentCommand {\keps} {} {{\(k\)-\(\varepsilon\)-}}
% k- omega - model
\NewDocumentCommand {\komega} {} {{\(k\)-\(\omega\)-}}
%Symmetry generators
...
\NewDocumentCommand {\infGenX} {} {\infGen{x_i}}
\NewDocumentCommand {\infGenGal} {} {X_{\infGen{\text{Gal}_i}}}
...
\NewDocumentCommand {\gloSymmX} {} {\gloSymm{x_i}}
\NewDocumentCommand {\gloSymmGal} {} {\gloSymm{\text{Gal}_i}}
...
\NewDocumentCommand {\gloSymmTransStat} { m } {X_{\text{Tr,stat,#1}}}
